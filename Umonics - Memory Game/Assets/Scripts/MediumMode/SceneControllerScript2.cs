...
public class SceneControllerScript2 : MonoBehaviour
{
    ...
    [SerializeField] private MainCardScript2 originalCard;
    ...
    private void Start() {
        ...
        for(int i = 0; i < gridColumns; i++) {
            for(int j = 0; j < gridRows; j++) {
                MainCardScript2 card;
                // if not original card, instantiate a new card
                if(i == 0 && j == 0) {
                    card = originalCard;
                }
                else {
                    card = Instantiate(originalCard) as MainCardScript2;
                }
    ...
    private MainCardScript2 _firstRevealed;
    private MainCardScript2 _secondRevealed;
    ...
    public void CardRevealed(MainCardScript2 card) {
